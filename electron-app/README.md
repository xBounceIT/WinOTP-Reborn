...
The renderer uses the native bridge for account listing, add/edit/delete, and usage counters. QR capture, backup, update, and Windows Hello actions still surface their existing bridge boundaries.
